...
template = {
    ...
    'index'    : '<div id="nav-index"><h1>Архив форума от %(forum-timestamp)s</h1></div><table id="forum-list"><colgroup><col/><col width="60"/><col width="60"/></colgroup><tr class="row-first"><th>Форумы</th><th>Тем</th><th>Ответов</th></tr>',
    ...
    'block'         : '<div id="nav"><p><a href="../index.html">Архив форума от %(forum-timestamp)s</a> → <span class="block-title">%(block-title)s</span></p></div><table id="forum-list"><colgroup><col/><col width="50"/><col width="100"/><col width="100"/></colgroup><tr class="row-first"><th>Тема</th><th>Ответов</th><th>Создана</th><th>Последний ответ</th></tr>',
    '/block':'</table>',

    'block_theme'   : '<tr class="row-%(theme-oddity)s"><td class="theme_title"><a href="%(theme-filename)s"  class="hotspot"  onmouseover="tooltip.show(\'%(theme-spoiler)s\');" onmouseout="tooltip.hide();">%(theme-title)s</a></td><td class="theme_answers">%(theme-answers)s</td><td class="theme_author">%(theme-author)s <div class="theme_timestamp">%(theme-timestamp)s</div></td><td class="theme_author">%(theme-lastauthor)s <div class="theme_timestamp">%(theme-lasttimestamp)s</div></td></tr>',
